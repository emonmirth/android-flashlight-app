...
- [x] Test camera torch, shake detection, pocket protection and notification on a physical Android device
- [x] Simplified adaptive icon artwork
- [x] Android application ID set to `com.eonmirth.glim`
...
3. When it completes, download **Glim-debug-apk** from the workflow artifacts.
